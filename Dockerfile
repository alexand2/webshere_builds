...
ENV WLP_OUTPUT_DIR="/opt/IBM/WebSphere/Liberty/usr/servers/" im_installer="agent.installer.linux.gtk.x86_64-1.8.3.zip" java_installer="ibm-java-jre-8.0-5.30-x86_64-archive.bin" was_file="wlp-kernel-18.0.0.4.zip" LIBERTY_DIR="/opt/IBM/WebSphere/Liberty" JAVA_URL="http://public.dhe.ibm.com/ibmdl/export/pub/systems/cloud/runtimes/java/8.0.5.30/linux/x86_64/" WEBSPHERE_URL="https://ak-delivery04-mul.dhe.ibm.com/sar/CMA/WSA/07zlk/0/" INSTALL_DIR="/opt/IBM/" user="wasadmin" group="root"
